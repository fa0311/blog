---
title: "FlutterアニメーションにおけるAnimationControllerの考え方"
emoji: "🎞️"
type: "tech"
topics: ["flutter", "dart", "animation"]
published: false
static: true
---
...
値の変化を宣言するだけでアニメーションを実現することができます。
...
このアプローチは分かりやすく、状態中心のUI設計とも相性が良い設計です。
...
まずは `Tween` を使わずに、単純なアニメーションを作ってみます。
...
いずれの `Tween` も本質的には値の変換です。
どのような変換を行うかは、その実装によって決まります。
